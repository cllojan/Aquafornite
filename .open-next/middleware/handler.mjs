  ...
  `);
      ...
      async function bE(a10) {
        ...
        return ((a11, b3) => {
          ...
          let c2 = "headers" in a11 ? a11.headers : a11, d2 = a11 instanceof Request ? a11 : void 0;
          !function(a12, b4, c3, d3) {
            ...
            let e3 = c3?.headers.get("x-forwarded-host"), f3 = c3?.headers.get("x-forwarded-proto");
          ...
          return k2 || null;
        })(a10) || "/perfil" !== b2 ? S.next() : S.redirect(new URL("/auth", a10.url));
      }
...
var BuildId = "Lw5sFBlizXtiUZcyk6Pqs";
